...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
		...
		if (!m_paneExpl.Create("Explorer", this, CSize(500, 250), TRUE, IDD_EXPLORER_PARENT, WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS | WS_CLIPCHILDREN | CBRS_LEFT| CBRS_FLOAT_MULTI) ||
			...
			if (!ff.FindFile(m_strImagesFileName))
			{
				...
				if (!::CopyFile(strDefault, m_strImagesFileName, TRUE))
				{
					...
					else
					{
						...
						{
							, 
						};

						UncompressAndWriteFile(m_strImagesFileName, file_data, sizeof(file_data));
					}
				}
			}
		}
