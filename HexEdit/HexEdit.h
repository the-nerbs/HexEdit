...
enum { MACRO_OPTIONS_PAGE = 1, PRINTER_OPTIONS_PAGE, 
	   FILTER_OPTIONS_PAGE, WIN_OPTIONS_PAGE, BACKGROUND_OPTIONS_PAGE, 
	   EXPLORER_OPTIONS_PAGE, INFOTIPS_OPTIONS_PAGE, DISPLAY_OPTIONS_PAGE,
	   COLOUR_OPTIONS_PAGE,
	};
