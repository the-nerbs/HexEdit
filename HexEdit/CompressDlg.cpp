...
void CCompressDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Radio(pDX, IDC_COMPRESSION_STRATEGY_DEF, m_strategy);
}
...
static DWORD id_pairs[] = {
	...
	IDC_COMPRESSION_HEADER_ZLIB, HIDC_COMPRESSION_HEADER_ZLIB, 
	IDC_COMPRESSION_HEADER_GZIP, HIDC_COMPRESSION_HEADER_GZIP, 
	IDC_COMPRESSION_STRATEGY_DEF, HIDC_COMPRESSION_STRATEGY_DEF, 
	IDC_COMPRESSION_STRATEGY_FILTERED, HIDC_COMPRESSION_STRATEGY_DEF, 
